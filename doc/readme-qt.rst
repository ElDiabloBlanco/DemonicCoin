DarkCoin-qt: Qt5 GUI for DarkCoin
===============================
...
Alternatively, install Qt Creator and open the `darkcoin-qt.pro` file.
...
The static binary version of DarkCoin is linked against libdb 5.0 (see also `this Debian issue`_).
